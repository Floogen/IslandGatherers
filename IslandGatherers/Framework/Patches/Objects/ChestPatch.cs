...
namespace IslandGatherers.Framework.Patches.Objects
{
    internal class ChestPatch : PatchTemplate
    {
        ...
        {
            if (__instance.modData.ContainsKey(IslandGatherers.parrotPotFlag) && __instance is Chest chest)
            {
                float draw_x = x;
                float draw_y = y;
